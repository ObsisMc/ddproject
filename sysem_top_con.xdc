...
set_property IOSTANDARD LVCMOS33 [get_ports {keyrow[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {keyrow[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {keyrow[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {keyrow[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {customer_buycount[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {customer_buycount[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {customer_buycount[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {customer_buycount[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {customer_buycount[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {customer_buycount[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {customer_buycount[0]}]
...
set_property PACKAGE_PIN Y9 [get_ports {customer_buycount[0]}]
set_property PACKAGE_PIN W9 [get_ports {customer_buycount[1]}]
set_property PACKAGE_PIN Y7 [get_ports {customer_buycount[2]}]
set_property PACKAGE_PIN Y8 [get_ports {customer_buycount[3]}]
set_property PACKAGE_PIN AB8 [get_ports {customer_buycount[4]}]
set_property PACKAGE_PIN AA8 [get_ports {customer_buycount[5]}]
set_property PACKAGE_PIN V8 [get_ports {customer_buycount[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports adminsetzero]
set_property IOSTANDARD LVCMOS33 [get_ports beep]
set_property IOSTANDARD LVCMOS33 [get_ports clk]
set_property IOSTANDARD LVCMOS33 [get_ports isenquire]
set_property IOSTANDARD LVCMOS33 [get_ports isreplenish]
set_property IOSTANDARD LVCMOS33 [get_ports istotalincome]
set_property IOSTANDARD LVCMOS33 [get_ports rst]
set_property PACKAGE_PIN Y18 [get_ports clk]
set_property PACKAGE_PIN W4 [get_ports rst]
set_property PACKAGE_PIN R4 [get_ports isenquire]
set_property PACKAGE_PIN T4 [get_ports isreplenish]
set_property PACKAGE_PIN T5 [get_ports istotalincome]
set_property PACKAGE_PIN U5 [get_ports adminsetzero]
set_property PACKAGE_PIN W6 [get_ports {password[0]}]
set_property PACKAGE_PIN W5 [get_ports {password[1]}]
set_property PACKAGE_PIN U6 [get_ports {password[2]}]
set_property PACKAGE_PIN V5 [get_ports {password[3]}]
set_property PACKAGE_PIN R6 [get_ports {password[4]}]
